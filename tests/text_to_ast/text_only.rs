...
fn email_address_standalone() {
    ...
    assert_eq!(parse_only_text("(mrcow@moo.com)"), vec![Text("("), EmailAddress("mrcow@moo.com"), Text(")")]);
    assert_eq!(parse_only_text("(mr.cow@moo.com"), vec![Text("("), EmailAddress("mr.cow@moo.com")]);
    assert_eq!(parse_only_text("[mr.cow@moo.com]"), vec![Text("["), EmailAddress("mr.cow@moo.com"), Text("]")]);
    assert_eq!(parse_only_text("mr.cow@moo.com}"), vec![EmailAddress("mr.cow@moo.com"), Text("}")]);
}
